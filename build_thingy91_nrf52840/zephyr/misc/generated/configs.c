...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EVENT_MANAGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EVENT_MANAGER_SHOW_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EVENT_MANAGER_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EVENT_MANAGER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EVENT_MANAGER_EVENT_LOG_BUF_LEN, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EVENT_MANAGER_LOG_EVENT_TYPE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAMDISK_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_DEVICE_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_MASS_STORAGE_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LINKER_ORPHAN_SECTION_PLACE, 1);
